  ...
  (
    {
      ...
      subtitle = {
        regular: "Post Projects, Bid Gigs, ",
      ...
      bottomImage = {
        ...
        dark: "/images/stugig-dark-dashboard.png",
      },
      gridOptions,
      ...props
    },
    ...
    return (
      <div className={cn("relative", className)} ref={ref} {...props}>
        ...
        <div
          className="absolute top-0 z-[0] h-screen w-screen bg-cover bg-center dark:hidden"
          style={{ backgroundImage: `url('${bottomImage.light}')` }}
        />
        <div
          className="absolute top-0 z-[0] h-screen w-screen bg-cover bg-center hidden dark:block"
          style={{ backgroundImage: `url('${bottomImage.dark}')` }}
        />
          ...
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-28 gap-12 md:px-8">
            <div className="space-y-5 max-w-3xl leading-0 lg:leading-5 mx-auto text-center">
              <h2 className="text-4xl tracking-tighter font-geist bg-clip-text text-transparent mx-auto md:text-6xl bg-[linear-gradient(180deg,_#000_0%,_rgba(0,_0,_0,_0.75)_100%)] dark:bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)]">
                {subtitle.regular}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-500 dark:from-purple-300 dark:to-cyan-200">
                  {subtitle.gradient}
                </span>
              </h2>
